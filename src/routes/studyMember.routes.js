...
// 🎫 My 멤버십 확인 - GET /api/studies/:studyId/members/me 요청을 받아 getMysStudyMembership 컨트롤러와 연결
router.get("/me", requireAuth, getMyStudyMembership);

// 🎫 스터디 참여하기 - POST /api/studies/:studyId/members/join 요청을 받아 joinStudy 컨트롤러와 연결
router.post("/join", requireAuth, joinStudy);

// 🎫 스터디 탈퇴하기 - POST /api/studies/:studyId/members/leave 요청을 받아 leaveStudy 컨트롤러와 연결
